...
df = wb.read_csv('fredgraph_annual.csv', index_col=0)
print(df)
print()
...
df_filtered.to_excel("sigma_annual.xlsx", index=False)
print(df_filtered)
